export const projects = [
  ...
  },
  {
    ...
    description: "Блог выполненый на React. Содержит в себе авторизацию, пользователя администратор. Добавление, редактирование и удаление постов с последующей отправкой их на сервер. Выполнен поиск по постам.",
...
export const TimeLineData = [
  { year: 2013, text: "Магистратура по специальности 'Управление и информатика в технических системах'" },
